...
def extract_features_from_cif(cif_path):
    ...
    try:
        ...
        # 特别关注锂含量（对锂电池材料特别重要）
        li_fraction = element_fractions.get('Li', 0)
...
def main(input_csv, cif_directory, output_csv):
    ...
    # 8. Save model
    with open('KRR_capacity_model.pkl', 'wb') as f:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="KRR model for material property prediction")
    parser.add_argument("--input_csv", type=str, default="/home/user1/code/data/material_Li_g/id_prop.csv",
                        help="Input CSV file with IDs and target values")
    parser.add_argument("--cif_dir", type=str, default="/home/user1/code/data/material_Li_g/",
